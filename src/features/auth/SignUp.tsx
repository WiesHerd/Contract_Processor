  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.name === 'UsernameExistsException') {
        ...
        setError('Password does not meet requirements. Please ensure it has at least 8 characters, includes uppercase, lowercase, numbers, and special characters.');
      } else if (err.name === 'InvalidParameterException' && err.message.includes('email')) {
